resource "azurerm_network_interface" "this" {
  name                = var.network_interface.name != null ? var.network_interface.name : local.defaults.network_interface.name
  ...
  ip_configuration {
    name                          = try(var.network_interface.ip_configuration.name, null) != null ? var.network_interface.ip_configuration.name : local.defaults.network_interface.ip_configuration.name
    private_ip_address_allocation = try(var.network_interface.ip_configuration.private_ip_address_allocation, null) != null ? var.network_interface.ip_configuration.private_ip_address_allocation : local.defaults.network_interface.ip_configuration.private_ip_address_allocation
...
resource "azurerm_linux_virtual_machine" "this" {
  ...
  os_disk {
    name = var.os_disk.name != null ? var.os_disk.name : local.defaults.os_disk.name
